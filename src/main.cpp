...
#if defined(NDEBUG)
# error "KoreaTrueMoney cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "KoreaTrueMoney Signed Message:\n";
...
{
    RenameThread("koreatruemoney-loadblk");
